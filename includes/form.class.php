<?php
	...
	add_action('wbcr_factory_forms_000_plugin_created', 'wbcr_factory_forms_000_plugin_created');

	function wbcr_factory_forms_000_plugin_created($plugin)
	{
		$plugin->forms = new Wbcr_FactoryForms000_Manager($plugin);
	}

	if( !class_exists('Wbcr_FactoryForms000_Manager') ) {

		class Wbcr_FactoryForms000_Manager {
			 ...
			 *
			 * @see FactoryForms000_Form::registerControl()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms000_Form::registerHolder()
			 *
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @see FactoryForms000_Form::registerCustomElement()
			 *
			 * @since 1.0.0
			 * @return void
			 */
	...
	if( !class_exists('Wbcr_FactoryForms000_Form') ) {
		/**
		 * An abstraction for forms.
		 */
		class Wbcr_FactoryForms000_Form {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_IFactoryForms000_ValueProvider
			 */
			private $provider;
			...
			public function __construct(array $options = array(), Wbcr_Factory000_Plugin $plugin)
			{
				...
				Wbcr_FactoryForms000_Manager::$temper = 'flat';
			}
			 ...
			 *
			 * @since 1.0.0
			 * @param Wbcr_IFactoryForms000_ValueProvider $provider
			 * @return void
			 */
			...
			{
				return apply_filters('wbcr_factory_000_form_items', $this->items, $this->name);
			}
			 ...
			 * @return Wbcr_FactoryForms000_FormElement|null A form element.
			 */
			 ...
			 * @return Wbcr_FactoryForms000_FormElement[] Created elements.
			 */
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms000_Control A control object.
			 */
			public function createControl($item)
			{
				...
				if( is_array($item) ) {
					...
					$control_data = Wbcr_FactoryForms000_Manager::$registered_controls[$item['type']];
			 ...
			 * @since 1.0.0
			 * @param array $item Item data.
			 * @return Wbcr_FactoryForms000_Holder A control holder object.
			 */
			public function createHolder($item)
			{
				...
				if( is_array($item) ) {
					...
					$holderData = Wbcr_FactoryForms000_Manager::$registered_holders[$item['type']];
			...
			public function createCustomElement($item)
			{
				...
				if( is_array($item) ) {
					...
					$data = Wbcr_FactoryForms000_Manager::$registered_custom_elements[$item['type']];
			...
			public function html($options = array())
			{
				...
				if( !isset(Wbcr_FactoryForms000_Manager::$form_layouts[$this->form_layout]) ) {
					die(sprintf('[ERROR] The form layout %s was not found.', $this->form_layout));
				}

				// include a render code
				$layout_data = Wbcr_FactoryForms000_Manager::$form_layouts[$this->form_layout];
			...
			public static function connectAssetsForItem($item)
			{
				...
				if( self::isControl($type) ) {
					$haystack = Wbcr_FactoryForms000_Manager::$registered_controls;
				} elseif( self::isControlHolder($type) ) {
					$haystack = Wbcr_FactoryForms000_Manager::$registered_holders;
				}
			...
			{
				return isset(Wbcr_FactoryForms000_Manager::$registered_controls[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms000_Manager::$registered_holders[$item['type']]);
			}
			...
			{
				return isset(Wbcr_FactoryForms000_Manager::$registered_custom_elements[$item['type']]);
			}
		}
	}
<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms000_Control extends Wbcr_FactoryForms000_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms000_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */

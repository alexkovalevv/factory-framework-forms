<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms000_FormLayout extends Wbcr_FactoryForms000_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-000-' . $this->type);
				$this->addCssClass('factory-forms-000-' . $this->name);
			}

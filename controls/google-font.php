...
class FactoryForms000_GoogleFontControl extends FactoryForms000_FontControl 
{
    ...
    public function __construct($options, $form, $provider = null) {
        ...
        $this->googleFontData = new FactoryForms000_HiddenControl( $optionGoogleFontData, $form, $provider );
    ...
    public function getDefaultFonts() {
        ...
        $fontsCommon = array( 'group', __('Standard:', 'factory_forms_000'), array(

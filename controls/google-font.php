<?php
	 ...
	 * @since 1.0.0
	 */
	class Wbcr_FactoryForms000_GoogleFontControl extends Wbcr_FactoryForms000_FontControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->google_font_data = new Wbcr_FactoryForms000_HiddenControl($option_google_font_data, $form, $provider);

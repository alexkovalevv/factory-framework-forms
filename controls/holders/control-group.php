<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_ControlGroupHolder') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms000_ControlGroupHolder extends Wbcr_FactoryForms000_ControlHolder {
				...
				<ul class="factory-control-group-nav">
					<?php
						foreach($this->elements as $element):
							...
							$builder = new Wbcr_FactoryForms000_HtmlAttributeBuilder();

<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_ColorAndOpacityControl') ) {
	}

	class Wbcr_FactoryForms000_ColorAndOpacityControl extends Wbcr_FactoryForms000_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->opacity = new Wbcr_FactoryForms000_IntegerControl($options['opacity'], $form, $provider);

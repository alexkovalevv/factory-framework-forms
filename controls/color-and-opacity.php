...
class FactoryForms000_ColorAndOpacityControl extends FactoryForms000_ComplexControl 
{
    ...
    public function __construct( $options, $form, $provider = null ) {
        ...
        $this->opacity = new FactoryForms000_IntegerControl( $options['opacity'], $form, $provider );

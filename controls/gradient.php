<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_GradientControl') ) {
		class Wbcr_FactoryForms000_GradientControl extends Wbcr_FactoryForms000_Control {
			...
			public function html()
			{
				...
				<script>
					...
					factory.res.resVertical = '<?php _e( 'vertical', 'wbcr_factory_forms_000' ) ?>';
					factory.res.resHorizontal = '<?php _e( 'horizontal', 'wbcr_factory_forms_000' ) ?>';
				</script>
				<div <?php $this->attrs() ?>>

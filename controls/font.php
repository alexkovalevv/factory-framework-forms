<?php
	 ...
	 * @since 1.0.0
	 */
	class FactoryForms000_FontControl extends FactoryForms000_ComplexControl {
		...
		public function __construct($options, $form, $provider = null)
		{
			...
			$this->size = new FactoryForms000_IntegerControl($optionFontSize, $form, $provider);
			$this->family = new FactoryForms000_DropdownControl($optionFontFamily, $form, $provider);
			$this->color = new FactoryForms000_ColorControl($optionFontColor, $form, $provider);
		...
		public function getFonts()
		{
			...
			$fonts = apply_filters('factory_forms_000_fonts', $fonts);
			$fonts = apply_filters('factory_forms_000_fonts-' . $this->options['name'], $fonts);

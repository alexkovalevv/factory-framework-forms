<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_FontControl') ) {

		class Wbcr_FactoryForms000_FontControl extends Wbcr_FactoryForms000_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->size = new Wbcr_FactoryForms000_IntegerControl($option_font_size, $form, $provider);
				$this->family = new Wbcr_FactoryForms000_DropdownControl($option_font_family, $form, $provider);
				$this->color = new Wbcr_FactoryForms000_ColorControl($optionFontColor, $form, $provider);
			...
			public function getFonts()
			{
				...
				$fonts = apply_filters('wbcr_factory_forms_000_fonts', $fonts);
				$fonts = apply_filters('wbcr_factory_forms_000_fonts-' . $this->options['name'], $fonts);

<?php
	...
	if( !class_exists('Wbcr_FactoryForms000_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms000_Bootstrap3FormLayout extends Wbcr_FactoryForms000_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms000_Control $control
			 */

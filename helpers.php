 ...
 * @since 1.0.0
 */
class FactoryForms000_FormHelpers {
    ...
    public static function render( $type, $options = array() ) {
        ...
        if ( FactoryForms000_Form::isControl($type) ) {
            self::renderControl($type, $options);
        } elseif ( FactoryForms000_Form::isControlHolder($type) ) {
    ...
    public static function renderControl($type, $options) {
        FactoryForms000_Form::connectAssetsForItem( $options );
